...
onnx_file_name = "./work_dir/mnist_2/model.onnx"
...
weights=torch.load("/home/dingyuning/torch_demo/work_dir/mnist_2/runs-1-3750.pt")
...
dummy_input = torch.randn(batch_size, 1, 28,28) # dummy_input就是一个输入的实例，仅提供输入shape、type等信息
